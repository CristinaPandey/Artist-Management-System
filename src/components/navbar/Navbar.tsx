...
function Navbar() {
  ...
  const activeLink = useNavStore((state: any) => state.activeLink);
  const activeLabel = useNavStore((state: any) => state.activeLabel);
  const setActiveLabel = useNavStore((state: any) => state.setActiveLabel);
  const setActiveLink = useNavStore((state: any) => state.setActiveLink);
  const setActiveBreadcrumbLabel = useNavStore(
    (state: any) => state.setActiveBreadCrumbLabel
  );
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{}}>
        ...
        <Drawer
          ...
          anchor="left"
        >
          <Toolbar>{/* <img src={Logo} alt="Nic ASIA Capital" /> */}</Toolbar>
          <Divider />
          <List sx={{}}>
